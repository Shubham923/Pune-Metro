...
ServletContext context=getServletContext();  
 bool=(Boolean)context.getAttribute("bool");  
...
<% } %>
 ...
 <%System.out.println(cardid); %>
  ...
  query="select * from user_history where cardid="+cardid+" order by trans_date DESC limit 10";
...
%>
    ...
    %>
 	...
 	<h2>Want to buy a new Smartcard ?</h2>

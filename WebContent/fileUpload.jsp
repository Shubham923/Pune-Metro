...
<html>
<head><title>Generate Report | Pune Metro</title></head>
...
<%
	...
	boolean bool2=(boolean)context.getAttribute("revpdf");
	if(bool2)
	{
...
window.alert("Report Successfully Generated !!");
...
<form  action="FileUpload" method="post">
  ...
  <input type="submit" class="btn btn-info btn-lg" value="Generate Report"/>
</form>

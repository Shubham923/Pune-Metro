...
<div class="columns">
  <ul class="price">
	...
	<input class="button" type="button" name="bt" value="Buy" onclick="{this.value=document.frm2.hdnbt12.value;document.frm2.submit(),alert("Hii");}" />  </ul></li>
	</form>
  </ul>
</div>

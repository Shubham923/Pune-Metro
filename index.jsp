  ...
  <div class="row text-center">
    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
      <h1 data-scroll-reveal="enter from the bottom after 0.2s"  class="header-line">ROUTES</h1>
        <p data-scroll-reveal="enter from the bottom after 0.3s" >THIS IS ROUTES SECTION<br>
          <div class="route">
          ...
          <div class="mvp1">
            <div class="r1">
              <ul class="squ">
                <li class="r11">PCMC</li><br>
                <li class="r11">Sant Tukaram Nagar</li><br>
                <li class="r11">Bhosari</li><br>
                <li class="r11">Kasarvadi</li><br>
                <li class="r11">Phugewadi</li><br>
              </ul>
            </div>
            <div class="r1">
              <ul class="squ">
                <li class="r22">Dapodi</li><br>
                <li class="r22">Bopodi</li><br>
                <li class="r22">Khadki</li><br>
                <li class="r22">Range Hills</li><br>
                <li class="r22">Shivajinagar</li><br>
              </ul >
            </div>
            <div class="r1"> 
              <ul class="squ">
                <li class="r33">Civil Court</li><br>
                <li class="r33">Budhwar Peth</li><br>
                <li class="r33">Mandai</li><br>
                <li class="r33">Swargate</li><br>
              </ul>
            </div>
           <!-- <div class="r1">
              <div class="map">
          ...
          <div class="mvp2" style="display:none">
            <div class="r1">
              <ul class="squ">
                ...
                <li class="r11">Ideal Colony</li><br>
                <li class="r11">Nal Stop</li><br>
                <li class="r11">Garware College</li><br>
                <li class="r11">Deccan Gymkhana</li><br>
              </ul>
            </div>
            <div class="r1">
              <ul class="squ">
                <li class="r22">Chhatrapati Sambhaji Udyan</li><br>
                <li class="r22">PMC</li><br>
                <li class="r22">Civil Court</li><br>
                <li class="r22">Mangalwar Peth</li><br>
                <li class="r22">Pune Railway Station</li><br>
                <li class="r22">Ruby Hall Clinicu</li><br>
              </ul >
            </div>
            <div class="r1"> 
              <ul class="squ">
                <li class="r33">Bund Garden</li><br>
                <li class="r33">Yerawada</li><br>
                <li class="r33">Kalyani Nagar</li><br>
                <li class="r33">Ramwadi </li><br>
              </ul>
            </div>
          </div>
        </p>
